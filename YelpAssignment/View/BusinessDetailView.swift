...
struct BusinessDetailView: View {
    ...
    var body: some View {
        buildBodyView()
            .onAppear {
                _ = self.viewModel.fetchBusinessDetail()
                _ = self.viewModel.fetchBusinessReviews()
        }
    ...
    func buildHeaderView(_ business: Business) -> AnyView {
        return AnyView(
            ZStack {
                VStack {
    ...
    func buildMidContentView(_ business: Business) -> AnyView {
        return AnyView(
            VStack {
                HStack {
    ...
    func buildBodyView() -> AnyView {
        if let business = viewModel.business.value {
            return AnyView(
                ScrollView {
                    VStack {
                        buildHeaderView(business)
                        .frame(height: 200)
                        .background(Color.gray.opacity(0.3))
                        buildMidContentView(business)
...
struct BusinessDetailView_Previews: PreviewProvider {
    static var previews: some View {
        BusinessDetailView(viewModel: BusinessDetailViewModel(apiClient: APIClient.defaultClient,
                               ...
                               business: Business(id: "sFKF4eyP6DKdr2o1qpykig",
                               name: "Lola Basyang's",
                               imageUrl: nil,
                               isClosed: nil, url: nil, price: nil,
                               phone: "+639228177570",
                               displayPhone: "+639228177570",
                               photos: [Stub.testPhotoURL,
                                        Stub.testPhotoURL,
                                        Stub.testPhotoURL,
                                        Stub.testPhotoURL],
                               rating: 4,
                               reviewCount: nil,
                               categories: [Category.init(alias: "Filipino", title: "Filipino"),
                               ...
                               Category.init(alias: "Meal", title: "Meal")], distance: 300000,
                                 coordinates: Coordinates.init(latitude: 14.675525, longitude: 121.0437512),
                                 location: Location(addressOne: "Jupiter Street", addressTwo: "G/F, Executive Building",
                                                    addressThree: nil, city: "Makati",
                                                    state: "NCR", zipCode: "", country: "PH",
                                                    displayAddress: ["Jupiter Street", "G/F, Executive Building",
                                                                     "Makati, Metro Manila", "Philippines"],
                                                    crossStreets: nil), transactions: nil,
                                                    hours: [Hour.init(hoursType: "Regular",
                                                    open: [Open.init(isOvernight: true,
                                                                     start: "1000", end: "2100", day: 0),
                                ...
                                profileURL: "https://vignette.wikia.nocookie.net/sd-smash" +
                                "/images/1/1d/Catto.jpg/revision/latest?cb=20190328215620",
                                imageURL: "https://vignette.wikia.nocookie.net/sd-smash/images" +
                                "/1/1d/Catto.jpg/revision/latest?cb=20190328215620",
                                name: "Catto"),
                                text: "Went back again to this place since the last " +
                                "time i visited the bay area 5 months ago," +
                                " and nothing has changed. Still the sketchy Mission, Still the cashier...",
                                timeCreated: "2016-08-29 00:41:13",
                                url: "https://www.yelp.com/biz/la-palma-mexicatessen-san" +
                                "-francisco?hrid=hp8hAJ-AnlpqxCCu7kyCWA&adjust_creative" +
                                "=0sidDfoTIHle5vvHEBvF0w&utm_campaign=yelp_api_v3" +
                                "&utm_medium=api_v3_business_reviews&utm_source=0sidDfoTIHle5vvHEBvF0w"),
                                Review.init(id: "32333",
                                  rating: 2, user: User.init(id: "32332",
                                profileURL: "https://vignette.wikia.nocookie.net/sd-smash/images/1" +
                                "/1d/Catto.jpg/revision/latest?cb=20190328215620",
                                imageURL: "https://vignette.wikia.nocookie.net/sd-smash/images" +
                                    "/1/1d/Catto.jpg/revision/latest?cb=20190328215620",
                                 name: "Catta"),
                                  text: "Went back again to this place since the last" +
